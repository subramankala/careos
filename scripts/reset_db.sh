...
MIGRATIONS=(
  ...
  "careos/db/migrations/0011_patient_day_plans.sql"
  "careos/db/migrations/0012_care_team_memberships.sql"
  "careos/db/migrations/0013_care_responsibility_assignments.sql"
)
